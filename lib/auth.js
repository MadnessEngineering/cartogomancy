...
const config = new Conf({
    ...
    encryptionKey: 'cartogomancy-cli-v1'
});
...
class AuthManager {
    ...
    async getAccessToken() {
        ...
        if (!auth) {
            throw new Error('Not authenticated. Run: cartogomancy login');
        }
        ...
        try {
            ...
            config.delete('auth');
            throw new Error('Session expired. Please login again: cartogomancy login');
        }
    }
